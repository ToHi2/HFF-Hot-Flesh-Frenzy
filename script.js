...
function confSht(){
 ...
 var fz = document.getElementById('fzman').offsetLeft;
 ...
 var hp = document.getElementById("hp").innerText;
  var hpa = document.getElementById("hpa").innerText;
   var hpb = document.getElementById("hpb").innerText;
    ...
    var fhp = document.getElementById("fhp").innerText;
    var hhp = (hp*1)-1;
    var hhpa = (hpa*1)-1;
    var hhpb = (hpb*1)-1;
    var hhpc = (hpc*1)-1;
    ...
    if (p == fz){
      document.getElementById("fhp").innerHTML=fhhp;
    }
...
function showFz(){
  document.getElementById("fzman").className="d"
}
function gameOver(){
  ...
  var fz = document.getElementById('fzman').offsetTop;
  var dz = (z*1)+50;
  var dza = (za*1)+50;
  var dzb = (zb*1)+50;
  var dzc = (zc*1)+50;
  var dzd = (zd*1)+50;
  var dfz = (fz*1)+50;
  if (dz >= p || dza >= p || dzb >= p || dzc >= p || dzd >= p||dfz>=p) {
